...
static IEnumerable<FileInfo> GetXmlFilePaths(string dirPath)
{
...
/// <exception cref="ArgumentException"></exception>
static DirectoryInfo CreateOutputDirInfo(string dirPath)
{
...
static void SetupLogger()
{
    ...
    ALog consoleLog = new CS.Logger.Console.Log();
    Log.AddLogger(consoleLog);
}
